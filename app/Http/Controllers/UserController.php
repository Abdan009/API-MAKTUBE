...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($data) {
            ...
            $getData = M_User2::where('username', $request->input('username'))->first();
            return response()->json([
                'code' => 200,
                'message' => 'Regitrasi Berhasil',
                'data' => $getData
    ...
    public function login(Request $request)
    {
        ...
        $data2 = M_User2::where('username', $request->input('username'))->first();
    ...
    public function getUserById($id)
    {
        ...
        $data2 = M_User2::where('id_user', $id)->first();
    ...
    public function deleteUser(Request $request)
    {
        ...
        $data2 = M_User2::where('id_user', $request->input('id_user'))->delete();
        ...
        if ($data) {
            ...
            return response()->json([
                'code' => 200,
                'message' => 'Data 2 Berhasil di delete',
            ]);
        }
