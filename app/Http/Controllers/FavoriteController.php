...
class FavoriteController extends Controller
{
    ...
    public function getMyFavorite($id)
    {
        try {
            ...
            $data =  M_Favorite2::with(['detailUser'])->where('id_user', $id)->get();
            if ($data) {
                return response()->json([
                    'code' => 200,
